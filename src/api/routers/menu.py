...
from src.schemas.menu import (
    ...
    MenuItemCustomizationCreate, MenuItemCustomizationResponse
)
...
@router.post("/items/{menu_item_id}/customizations", response_model=MenuItemCustomizationResponse, status_code=201)
